...
(function () {
  function c() {
    ...
    if (b) {
      ...
      d.innerHTML =
        "window.__CF$cv$params={r:'96216027a7d34734',t:'MTc1MzAwMzE1My4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (typeof Toastify !== "undefined") {
          Toastify({
            text:
              "Signup successful! " + (data.message || "Welcome to BlogZone!"),
            duration: 3000,
            gravity: "top",
            position: "right",
          ...
          showFallbackNotification(
            "Signup successful! Welcome to BlogZone!",
            "success"
          );
        }
...
function showFallbackNotification(message, type) {
  ...
  if (existingToast) {
    const toastMessage =
      existingToast.querySelector(".toast-message") || existingToast;
    toastMessage.textContent = message;
    existingToast.style.backgroundColor =
